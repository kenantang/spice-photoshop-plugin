...
2. **PPI inconsistency issues**  
   The current image-pasting logic is not robust to different PPI settings. This may cause corrupted results for some PPI settings, but can be completely avoided by using a consistent PPI.  
